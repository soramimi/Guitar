...
public:
	...
	static QString makeDateTimeString(const QDateTime &dt);
        static bool starts_with(const std::string_view &str, const std::string_view &with);
        static bool starts_with(const std::string_view &str, char with);
        static bool ends_with(const std::string_view &str, const std::string_view &with);
        static bool ends_with(const std::string_view &str, char with);
