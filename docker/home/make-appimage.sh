...
cp /Guitar/_bin/Guitar _appdir/usr/bin/
cp /Guitar/lib/libfiletypeplugin.so _appdir/usr/lib/
cp /Guitar/lib/libincrementalsearchplugin.so _appdir/usr/lib/
strip _appdir/usr/bin/Guitar
strip _appdir/usr/lib/libfiletypeplagin.so
strip _appdir/usr/lib/libincrementalsearchplugin.so
